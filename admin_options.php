...
if (isset($_POST['form_sent']))
{
	...
	$form = array(
		...
		'regs_captcha'			=> $_POST['form']['regs_captcha'] != '1' ? '0' : '1',
					...
					<fieldset>
						...
						<div class="infldset">
							<table class="aligntop">
								...
								<tr>
									<th scope="row"><?php echo $lang_admin_options['Captcha label'] ?></th>
									<td>
										<label class="conl"><input type="radio" name="form[regs_captcha]" value="1"<?php if ($pun_config['o_regs_captcha'] == '1') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['Yes'] ?></strong></label>
										<label class="conl"><input type="radio" name="form[regs_captcha]" value="0"<?php if ($pun_config['o_regs_captcha'] == '0') echo ' checked="checked"' ?> />&#160;<strong><?php echo $lang_admin_common['No'] ?></strong></label>
										<span class="clearb"><?php echo $lang_admin_options['Captcha help'] ?></span>
									</td>
								</tr>
								<tr>
