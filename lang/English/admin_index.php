...
'Running latest version message'	=>	'You are running the latest version of eveBB.',
'New version available message'		=>	'A new version of eveBB has been released. You can download the latest version at %s.',
...
'NA'								=>	'N/A',
'Welcome to admin'					=>	'Welcome to the eveBB administration control panel. From here you can control vital aspects of the board. Depending on whether you are an administrator or a moderator you can:',
...
'Update available'					=>	'A new version of eveBB (%1$s) is available. %2$s.',
'Update available link'				=>	'View the update',
'About head'						=>	'About eveBB',
'eveBB version label'				=>	'eveBB version',
'Check for upgrade'					=>	'Check for upgrade',
'eveBB version data'				=>	'v%s - %s',
...
'Show info'							=>	'Show info',
'Environment data version'			=>	'PHP: %s',
'Environment data acc'				=>	'Accelerator: %s',
'Zend OPcache'						=>	'Zend OPcache',
'Zend OPcache link'					=>	'www.php.net/manual/en/book.opcache.php',
'APCu'								=>	'APCu (user cache)',
'APCu link'							=>	'www.php.net/manual/en/book.apcu.php',
