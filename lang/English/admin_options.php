...
'Board logo help'					=>	'Optionally upload a logo image (PNG, JPEG, GIF or WebP) to show in place of the board-title text. If no logo is set, the text title above is used. The board title is used as the image\'s alt text.',
...
'Board logo size help'				=>	'Optional. Enter a width and/or height for the logo — a plain number is treated as pixels, or add a CSS unit (e.g. 100%, 300px, 8em). Leave both blank to use the image\'s natural size. Set width to 100% for a full-width banner.',
