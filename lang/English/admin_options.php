...
'Board logo size help'				=>	'Optional. Enter a width and/or height for the logo — a plain number is treated as pixels, or add a CSS unit (e.g. 300px, 8em). Leave both blank to use the image\'s natural size. (Ignored when the position below is set to "Full width".)',
'Board logo align label'			=>	'Logo position',
'Board logo align left'				=>	'Left',
'Board logo align center'			=>	'Centre',
'Board logo align right'			=>	'Right',
'Board logo align full'				=>	'Full width (banner)',
'Board logo align help'				=>	'Where to place the logo. Choose "Full width" for a banner that stretches across the whole header — for a crisp result the image should be at least about 990&nbsp;px wide (the content width of the bundled styles; use ~1980&nbsp;px for sharp display on high-resolution screens). The exact position is applied by the style sheet (#brdlogo), so a custom style can override it.',
